<nav>
	<div class="marg">
		<ul>
			...
			{
				?>
				<li><a href="connexion.php" title="page de connection" class="nav">Connexion</a></li>
				<li><a href="inscription.php" title="page d'inscription" class="nav">Inscription</a></li>
				<?php
			}
			?>
		</ul>
